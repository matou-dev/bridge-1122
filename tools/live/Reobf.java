...
public final class Reobf {
    public static void main(String[] a) throws Exception {
        ...
        // NoSuchMethodError MatouBlock.setHardness at the 1122 registry
        // event — same class as the 1710 setBlockName finding, ported
        // from bridge-1710's hierarchy-aware Reobf). Owners outside
        // net/minecraft/ walk this chain; the first SRG hit wins.
