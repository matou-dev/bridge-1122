...
/**
 * C2 end-to-end gate (no JUnit, same pattern as B2 in bridge-1710): real
 * example1 jobs from source content files, sealed snapshots, merged
 * decisions, landed on a recording fake world. Any violation prints
 * {@code FAIL bridge-content : ...} and exits 1. Run by tools/check.sh
 * against the {@code ../spi} + {@code ../example1} sibling checkouts.
 * Zero Minecraft. Body kept in sync with bridge-1710's copy by
 * convention (same shared seam, same example1).
 */
