...
/**
 * C1 live sink: pure decision cells to 1.12.2 world edits. Plane
...
public final class WorldCellSink implements CellSink {
    /** 1.12.2 overworld height: y lives in 0..255. */
    ...
    /** Single owner of the 1.12.2 height rule (also used at wire bind). */
