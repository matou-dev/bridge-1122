...
/**
 * C1 port of the 1710 live binding (bind proven E2E in C2): one configured
 * pack plus where its cells land. Bound once at init (fail fast), applied
 * per world tick. Only this package may touch MC/Forge.
 */
